...
cloudinary.config({
  secure: true
  // Lee CLOUDINARY_URL de las env vars automáticamente si está seteada.
  // Si se prefiere setear por separado, usar CLOUDINARY_CLOUD_NAME / CLOUDINARY_API_KEY / CLOUDINARY_API_SECRET.
});
